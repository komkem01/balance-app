...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (message.value) {
        _push(`<div class="fixed bottom-10 left-1/2 z-50 -translate-x-1/2 rounded-2xl border border-slate-100 bg-white px-8 py-4 text-[10px] font-bold uppercase tracking-widest text-slate-900 shadow-2xl">${ssrInterpolate(message.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=index-CpHuws9K.mjs.map
