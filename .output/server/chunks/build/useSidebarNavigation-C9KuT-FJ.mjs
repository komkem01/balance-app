...
const useAuthApi = () => {
  ...
  const refreshMemberToken = async (refreshToken) => {
    ...
    const res = await request("/public/auth/refresh", {
      method: "POST",
      body: JSON.stringify({
        refresh_token: token
      })
...
export { __nuxt_component_1 as _, useAuthApi as a, useSidebarNavigation as u };
//# sourceMappingURL=useSidebarNavigation-C9KuT-FJ.mjs.map
